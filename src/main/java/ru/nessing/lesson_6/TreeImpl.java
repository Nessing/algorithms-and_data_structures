...
public class TreeImpl<E extends Comparable<? super E>> implements Tree<E>  {
    ...
    private class NodeAndParent {
        ...
        public NodeAndParent(Node<E> current, Node<E> parent, int levelCurrent) {
    ...
    private NodeAndParent doFind(E value) {
        ...
        while (current != null && levelCurrent <= 4) {
            levelCurrent++;
            if (current.getValue().equals(value)) {
                return new NodeAndParent(current, parent, levelCurrent);
            }
        ...
        return new NodeAndParent(null, parent, levelCurrent);
    }
