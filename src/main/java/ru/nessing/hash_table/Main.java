...
public class Main {
    ...
    public static void main(String[] args) {
        Map hashTable = new Map(5); //10

        hashTable.add(new Product(1, "Orange"), 150); //1
        hashTable.add(new Product(77, "Banana"), 100); //7
        hashTable.add(new Product(67, "Carrot"), 228); //8
        hashTable.add(new Product(60, "Lemon"), 250); //0
        hashTable.add(new Product(51, "Milk"), 120); //2
        hashTable.add(new Product(21, "Potato"), 67); //3
        ...
        hashTable.add(new Product(47, "Pineapple"), 228);

        hashTable.display();

//        HashTableImpl hashTable = new DoubleHashTable<>(5); //10
